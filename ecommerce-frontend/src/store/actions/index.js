...
export const bannerLists=[
    {
        id: 1,
        image: "https://www.pexels.com/photo/laptop-on-a-wooden-table-5202950/",
        title: "Macbook",
        subtitle: "Apple Macbook",
        description: "Apple's premimum Macbook Range",
    },
    {
        id: 2,
        image: "https://www.pexels.com/photo/gaming-laptop-on-wooden-surface-outdoors-33125275/",
        title: "Gaming Laptop",
        subtitle: "Hp Gaming Laptop",
        description: "Hp Premium gaing laptop",
    },
    {
        id: 3,
        image: "https://www.pexels.com/photo/photo-of-silver-dell-laptop-9474023/",
        title: "Gaming Laptop",
        subtitle: "Hp Gaming Laptop",
        description: "Hp Premium gaing laptop",
    },
...
export const increaseCartQuantity = 
    ...
    (dispatch, getState) => {
        ...
        // If products not available, allow increase anyway (for offline support)
        ...
        if (!getProduct) {
            // Product not found, allow increase anyway
            const newQuantity = currentQuantity + 1;
            setCurrentQuantity(newQuantity);
            dispatch({
                type: "ADD_CART",
...
export const getOrdersForDashboard = (queryString, isAdmin) => async (dispatch) => {
    try {
        console.log("=== getOrdersForDashboard Action Called ===");
