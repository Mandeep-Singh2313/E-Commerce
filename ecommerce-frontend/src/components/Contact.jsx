...
const Contact = () => {
    return(
        <div
            ...
            style={{backgroundImage: "url('https://images.pexels.com/photos/2506947/pexels-photo-2506947.jpeg')"}}>
                ...
                <div className="mt-8 text-center">
                    ...
                    <div className="flex flex-col items-center space-y-2 mt-4">
                        <div className="flex items-center">
                            ...
                            <span className="text-gray-600">+91 9858005648</span>
                        </div>

                        <div className="flex items-center">
                            <FaEnvelope className="text-blue-500 mr-2"/>
                            <span className="text-gray-600">mswork2313@gmail.com</span>
                        </div>
