...
const ItemContent = ({
    ...
    const handleQtyIncrease = (cartItems) => {
        console.log("🔥 Increase clicked - currentQuantity:", currentQuantity, "cartItems:", cartItems);
    ...
    const handleQtyDecrease = (cartItems) => {
        console.log("🔥 Decrease clicked - currentQuantity:", currentQuantity, "cartItems:", cartItems);
